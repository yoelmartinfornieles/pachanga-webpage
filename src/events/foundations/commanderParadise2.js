...
Las "jugadas de despecho", "kingmaking" y perder o "conceder" intencionalmente son ejemplos de comportamiento antideportivo y pueden estar sujetos a penalización o suspensión. 
Los oficiales del torneo pueden ejercer como jueces para ayudar a los jugadores a resolver sus problemas técnicos, pero de ninguna manera están obligados a hacerlo. Para ello, contaremos con un equipo de jueces encargados de resolver dudas.
Commander es un formato que permite mucha conversación de estrategias. Procura llevar estas partidas con buena actitud y filosofía. Además, intenta mantener un nivel de voz adecuado que no moleste al resto de jugadores.
